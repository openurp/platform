[#list messages as message]
    <a class="dropdown-item" href="${urp.webapp}/platform/user/message/${message.id}" target="_blank">
      <div class="media">
  ...
  [/#list]
  <div>
    <a  class="float-right text-sm text-muted" href="${urp.webapp}/platform/user/message" target="_blank">
     <span>查看所有消息</span>
    </a>
  </div>
  <script>
