[#ftl]
[@b.head/]
<link href="${static_base}/kindeditor/4.1.11/themes/default/default.css" rel="stylesheet" type="text/css">
<script type="text/javascript" src="${static_base}/kindeditor/4.1.11/kindeditor-all-min.js"></script>
<script type="text/javascript" src="${static_base}/kindeditor/4.1.11/lang/zh-CN.js"></script>
[@b.toolbar title="新建/修改通知公告"]bar.addBack();[/@]
[#assign saveAction][#if notice.persisted]!update?id=${notice.id}[#else]!save[/#if][/#assign]
<style>form.listform label.title{width:120px;}</style>
[@b.form action=saveAction theme="list" onsubmit="return syncEditor()"]
