...
[@b.grid items=resources var="resource" sortable="true"]
  ...
  [@b.row]
    ...
    [@b.col  width="20%" property="title" title="common.title"]${(resource.title)!}[/@]
    [@b.col  width="13%" property="app.title" title="应用"/]
    ...
    [@b.col  width="12%" property="remark" title="common.remark"/]
  [/@]
[/@]
[@b.foot/]