 ...
 */
package org.openurp.platform.security.action.session
 ...
 * @author chaostone
 */
 class MonitorAction extends SecurityActionSupport {
   ...
   */
   ...
   void setCategoryProfileService(SessionProfileService categoryProfileService) {
    this.categoryProfileService = categoryProfileService
  }

   void setAccessMonitor(AccessMonitor accessMonitor) {
