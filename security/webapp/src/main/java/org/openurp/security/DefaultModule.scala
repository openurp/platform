...
import org.openurp.platform.security.action.*
 ...
 final class DefaultModule extends AbstractBindModule {
  ...
  protected void doBinding() {
    ...
    bind(org.openurp.platform.security.action.session.LogAction.class,
        org.openurp.platform.security.action.session.MonitorAction.class).property("entityDao",
        ref("sessionEntityDao"))

    bind(org.openurp.platform.security.action.nav.MenuAction.class,
        org.openurp.platform.security.action.nav.IndexAction.class,
        org.openurp.platform.security.action.nav.ProfileAction.class)

    bind(UserDashboardHelper.class).shortName()

    // data security
    bind(org.openurp.platform.security.action.data.ResourceAction.class,
        org.openurp.platform.security.action.data.PermissionAction.class)
