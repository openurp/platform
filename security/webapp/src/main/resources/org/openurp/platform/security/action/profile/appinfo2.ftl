...
[@b.form name="profileForm" action="!save"]
  <input type="hidden" name="_params" value="&profile.user.id=${Parameters['profile.user.id']}&profile.app.id=${Parameters['profile.app.id']}"/>
  <input type="hidden" name="profile.user.id" value="${Parameters['profile.user.id']}"/>
  <input type="hidden" name="profile.app.id" value="${Parameters['profile.app.id']}"/>
[/@]
