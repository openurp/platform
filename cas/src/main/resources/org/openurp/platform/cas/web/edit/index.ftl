  ...
  <div class="container">
   ...
   <script>
     ...
     jQuery(document).ready(function(){
       $.get("${urpapi}/platform/user/credentials/comment.json", function(result){
         comment=result;
     ...
     function checkPassword(password){
       $.post('${urpapi}/platform/user/credentials/check.json',{user:"${principal.name}",pwd:password}, function(data) {stengthOK=data;displayMessage();},'json');
     }
   </script>
  </div>
[@b.foot/]
